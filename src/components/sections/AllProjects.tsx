...
const CATEGORIES = ["All", "Full Stack", "Creative Dev", "E-Commerce", "3D Web", "Mobile & UI"];
...
export function AllProjects({ onSelectProject }: AllProjectsProps) {
  ...
  return (
    <section id="all-projects" className="relative py-20 px-6 sm:px-8 md:px-12 bg-white/[0.01]">
