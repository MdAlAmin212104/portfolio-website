      ...
      <div className="w-full max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-5 glass-card p-5 sm:p-8 rounded-3xl space-y-6 sm:space-y-8 max-w-full"
          >
            <div>
              <span className="inline-flex max-w-full items-center gap-2 px-3 py-1 rounded-full text-xs font-mono text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 mb-3">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse shrink-0" />
                <span className="truncate">{PERSONAL_INFO.availability}</span>
              </span>
              <h3 className="text-xl sm:text-2xl font-bold text-white">Direct Channels</h3>
            ...
            {/* Copy Email Box */}
            <div className="glass-dock p-3.5 sm:p-4 rounded-2xl border border-white/10 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 group hover:border-primary/40 transition-colors max-w-full">
              <div className="flex items-center gap-2.5 sm:gap-3 overflow-hidden min-w-0">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-primary/20 flex items-center justify-center text-primary shrink-0 group-hover:scale-105 transition-transform">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>
                <span className="text-[11px] sm:text-sm font-mono text-white truncate font-medium max-w-[170px] sm:max-w-none">
                  {PERSONAL_INFO.email}
                </span>
              </div>
              <button
                ...
                className="px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold text-white bg-gradient-to-r from-primary/30 to-accent/30 hover:from-primary hover:to-accent transition-all duration-300 flex items-center gap-1.5 shrink-0 border border-primary/40 shadow-sm ml-auto sm:ml-0"
                data-cursor="pointer"
              >
                {copied ? (
                  <>
            ...
            <a
              ...
              className="glass-dock p-3.5 sm:p-4 rounded-2xl border border-white/10 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 group hover:border-[#25D366]/50 transition-colors max-w-full"
              data-cursor="pointer"
              aria-label="Chat on WhatsApp"
            >
              <div className="flex items-center gap-2.5 sm:gap-3 overflow-hidden min-w-0">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#25D366]/15 flex items-center justify-center text-[#25D366] shrink-0 group-hover:scale-105 transition-transform">
                  <FaWhatsapp className="w-4 h-4 sm:w-5 sm:h-5" aria-hidden="true" />
                </div>
                <div className="overflow-hidden min-w-0">
                  <span className="block text-[11px] sm:text-sm font-mono text-white truncate font-medium">
                    +880 1707-691162
                  </span>
                  <span className="block text-[9px] sm:text-[10px] text-muted/60 font-mono mt-0.5">
                    WhatsApp
                  </span>
                </div>
              </div>
              <span className="px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold text-white bg-gradient-to-r from-[#25D366]/30 to-[#128C7E]/30 hover:from-[#25D366] hover:to-[#128C7E] transition-all duration-300 flex items-center gap-1.5 shrink-0 border border-[#25D366]/40 shadow-sm group-hover:from-[#25D366] group-hover:to-[#128C7E] ml-auto sm:ml-0">
